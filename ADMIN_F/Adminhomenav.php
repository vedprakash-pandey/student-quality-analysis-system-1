...
$report_selm = "select * from mentor_report where status='Not Viewed'";
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="batch_perform.php">Batch Performance</a>
              </li>

              <li class="nav-item">
                  <a class="nav-link" href="stu_perform.php">Student Performance</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="admin_report.php">View Report
                  <?php if($report_numm > 0){?>
                            <span style="font-size:15px;color:black;border-radius:50%;background:white;padding:2px 5px;margin-left:3px">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="admin_send.php">Send Report</a>
              </li>
